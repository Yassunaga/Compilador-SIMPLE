...
/**
 * Exceção na interpretação do código escrito em Simpletron Machine Language
 */
public class InterpretException extends Exception {
    ...
    /**
     * Constructs a new InterpretException with the specified detail message and
     * cause
     *
     * @param message the detail message
    ...
    /**
     * Constructs a new InterpretException with the specified cause and a detail
